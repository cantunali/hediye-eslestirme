...
const Login = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Redirect to Google — browser navigates away, no need to setLoading(false)
        } catch (err) {
            setError('Google ile giriş başarısız: ' + (err.message || 'Lütfen tekrar deneyin.'));
                    ...
                    <div className="form-group" style={{ marginBottom: '0' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input
                                type="email"
                                className="input"
                                style={{ paddingLeft: '2.75rem', color: '#333' }}
